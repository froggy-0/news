...
Usage:
    .venv/bin/python scripts/exploratory/twelvedata_probe.py --api-key YOUR_KEY
    TWELVEDATA_API_KEY=YOUR_KEY .venv/bin/python scripts/exploratory/twelvedata_probe.py
