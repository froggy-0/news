...
이 문서는 `docs/specs/public-brief-frontend/requirements.md` 와 `docs/specs/public-brief-frontend/design.md` 를 기준으로, 현재 저장소의 **Next.js 정적 export 프론트 + Python 파이프라인** 상태를 기준으로 남은 배포/검증 작업을 정리한 체크리스트다.
...
- [x] 1. Stage 1: 문서와 계약 기준 정합화
  - [x] 1.1 `schema/brief.types.ts` 신규 생성
    ...
    - `docs/specs/public-brief-frontend/design.md` 의 계약과 1:1로 맞춘다
