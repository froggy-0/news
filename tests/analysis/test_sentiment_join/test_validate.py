    ...
    return pd.DataFrame(
        {
            ...
            "btc_return_7d": [float("nan")],
            "btc_return_7d_lag1": [float("nan")],
            "open_interest_change_7d": [float("nan")],
            "open_interest_change_7d_lag1": [float("nan")],
            "oi_price_divergence_flag_7d": [float("nan")],
            "oi_price_divergence_flag_7d_lag1": [float("nan")],
            "oi_price_divergence_score_7d": [float("nan")],
            "oi_price_divergence_score_7d_lag1": [float("nan")],
