...
1. 거시 지표 Dashboard
- 원/달러 환율은 1,330.50원으로 전일 대비 +0.12%였습니다. [출처: KIS]
- 나스닥 선물은 전일 대비 +0.48%로 상승 방향입니다. [출처: yfinance]
- 공포탐욕지수는 60으로 탐욕 구간입니다. [출처: alternative.me]

2. 미국 증시
- AVGO는 전반적 시장 하락 영향으로 4.11% 하락했습니다. [출처: KIS]
- META는 광고 업종 약세 흐름으로 3.83% 하락했습니다. [출처: KIS]
- NVDA는 AI 투자 관련 뉴스 흐름 속에 1.20% 상승했습니다. [출처: KIS]
