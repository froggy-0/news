...
EXPECTED_LOGGER_CALL_FILES: set[str] = {
    ...
    "src/morning_brief/data/sources/asset_news_publisher.py",
...
EXPECTED_GET_LOGGER_FILES = {
    ...
    "src/morning_brief/analysis/sentiment_join/sources/macro_history.py",
    ...
    "src/morning_brief/analysis/sentiment_join/sources/vix.py",
    ...
    "src/morning_brief/data/sources/coindesk_news.py",
    ...
    "src/morning_brief/data/sources/marketaux_provider.py",
    "src/morning_brief/data/sources/newsdata_provider.py",
    "src/morning_brief/data/sources/perplexity_search.py",
    "src/morning_brief/data/sources/perplexity_sonar.py",
    "src/morning_brief/data/sources/thenewsapi_provider.py",
