...
MASTER_SCHEMA = pa.DataFrameSchema(
    {
        ...
        "btc_return_7d": pa.Column(float, nullable=True),
        "btc_return_7d_lag1": pa.Column(float, nullable=True),
        "open_interest_change_7d": pa.Column(float, nullable=True),
        "open_interest_change_7d_lag1": pa.Column(float, nullable=True),
        "oi_price_divergence_flag_7d": pa.Column(float, nullable=True),
        "oi_price_divergence_flag_7d_lag1": pa.Column(float, nullable=True),
        "oi_price_divergence_score_7d": pa.Column(float, nullable=True),
        "oi_price_divergence_score_7d_lag1": pa.Column(float, nullable=True),
