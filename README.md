...
- 상세 설계: [docs/specs/finbert-sentiment/](docs/specs/finbert-sentiment/)
...
- Codex 금융 플러그인 포팅 가이드: [docs/codex-financial-services-plugins.md](docs/codex-financial-services-plugins.md)
