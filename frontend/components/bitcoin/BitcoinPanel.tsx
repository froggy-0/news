        ...
        <div className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
            <div className="grid gap-4 md:grid-cols-[1.1fr_0.9fr]">
              <div className="section-shell card-family-data rounded-[var(--card-radius-data)] p-6">
                ...
                {bitcoin.price ? (
                  <p className="numeric mt-5 text-[2.3rem] text-white md:text-[3rem]">
                    {bitcoin.price}
                  </p>
                ) : (
                  <div className="mt-5">
                ...
                {bitcoin.fearGreedIndex ? (
                  <>
                    <div className="mt-5 flex items-end gap-3">
                      <p className="numeric text-[3rem] text-white">
                        {bitcoin.fearGreedIndex.value}
                      </p>
                      <span className="numeric pb-2 text-sm uppercase tracking-[0.18em] text-white/32">/100</span>
                    </div>
                    <p className="mt-3 text-[11px] font-mono uppercase tracking-[0.22em] text-[var(--accent-primary)]">
