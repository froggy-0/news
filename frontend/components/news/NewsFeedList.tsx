    ...
    <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
      {items.map((item, index) => {
        ...
        return (
          ...
          >
            <div className="absolute left-0 top-0 h-px w-full bg-gradient-to-r from-[#00ffff]/80 via-[#00ffff]/20 to-transparent" />
            ...
            <div className="flex flex-1 flex-col gap-6">
              <h3
                className={`card-reading-title font-bold tracking-tight text-white transition-colors group-hover:text-[#00ffff] ${
            ...
            <div className="mt-6 flex items-end justify-between border-t border-white/6 pt-5">
              ...
              <div className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 transition-all group-hover:border-[#00ffff]/40 group-hover:bg-[#00ffff]/10">
                <ExternalLink className="h-3.5 w-3.5 text-white/30 transition-colors group-hover:text-[#00ffff]" />
              </div>
            </div>
          </a>
        );
